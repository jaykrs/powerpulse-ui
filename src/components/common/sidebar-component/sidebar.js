            ...
            <div className="page-sidebar">
                <div style={{
                    ...
                    <div className="logo-wrapper compactLogo">
                        ...
                        <img className="blur-up lazyloaded" height="180px" width="110%" src={mohandess} alt="logo" style={{ margin: "-30px 0 0 -15px" }} />
                        {/* <img  className="blur-up lazyloaded" height="100px"  width="180px" src={mohandess} alt="" /> */}
                        {/* </Link> */}
                    </div>
                </div>

...
const LicenseList = (props) => {
    ...
    useEffect(() => {
        ...
        axios({
            method: "GET",
            url: "https://api.mohandess.com/api/eflpricings",
            data: data,
        }).then((response) => {
                                        ...
                                        <div className="card-header">
                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <div className='d-flex align-items-center'>
                                                        <div class="flex-grow-1">
                                                            <ul className="nav navbar-nav navbar">
                                                                <li>
                                                                    <h6>LICENSE</h6>
                                                                    <ul className='menu' style={{ fontSize: "9px" }}>
                                                                        <li><a>Floor(1-7):{item.attributes.lic1to7} SAR</a></li>
                                                                        <li><a>Floor(8-15):{item.attributes.lic8to15} SAR</a></li>
                                                                        <li><a>Floor(15+):{item.attributes.lic15plus} SAR</a></li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                ...
                                                <div class="flex-grow-3">
                                                    ...
                                                    <p>Service City</p>
                                                    <p>{item.attributes.servicecity} </p>
                                                    </div>
                                                </div>
                                                <div class="flex-grow-3">

                  ...
                  <div className="card-body">
                    <div className="row">
                      ...
                      <form className="theme-form mega-form" >
                          ...
                          <div className="form-group">
                          <h8>ORDER NUMBER</h8>
                            <input className="form-control col-12" disabled="true" type="text"value={'CIN-' + date + "-" + localStorage.getItem('pgid')} placeholder="OrderId" />
                          </div>
                          <div className="form-group">
                          <h8>ORDER AMOUNT ({localStorage.getItem('pgcurrency')})</h8>
                          <input className="form-control col-12" type="text" disabled="true" value={localStorage.getItem('pgprice')} placeholder="Amount" />
                          </div>
                          <div className="form-group">
                          <h8>NAME</h8>
                          <input className="form-control col-12" type="text" disabled="true" value={localStorage.getItem('pgname')} placeholder="Name" />
                          </div>
                          <div className="form-group">

...
class jobEngineerFirmForm extends Component {
    constructor(props) {
        super(props)
                      ...
                      <h5>Mega form</h5>
                                        ...
                                        <div className="card-body">
                                            <form className="theme-form">
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputPassword1">Service Region</label>
                                                    <input className="form-control" id="exampleInputPassword1" type="text" placeholder="Enter Service Region" />
                                                </div>
                                                <div className="form-group">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" type="country" placeholder="Enter Design" />
                                                </div>
                                                <div className="form-group">
...
export default jobEngineerFirmForm;
...
class jobCoustomerForm extends Component {
    constructor(props) {
        super(props)
                      ...
                      <h5>Mega form</h5>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <div className="form-group">
                                                    <label className="col-form-label">Total Transection</label>
                                                    <input className="form-control" type="text" placeholder="Enter Total Transection " />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputPassword1">Dial Code</label>
                                                    <input className="form-control" id="exampleInputPassword1" type="text" placeholder="Enter Dial Code" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputPassword1">Bank Account No</label>
                                                    <input className="form-control" id="exampleInputPassword1" type="text" placeholder="Enter Bank Account No" />
                                                </div>
                                                <div className="form-group">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" type="country" placeholder="Enter Remarks " />
                                                </div>
                                                
                                                <div className="form-group">
                                                    <label className="col-form-label">Wallet Valance</label>
...
export default jobCoustomerForm;
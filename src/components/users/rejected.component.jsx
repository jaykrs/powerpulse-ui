...
class Rejected extends Component {
  ...
  componentDidMount() {
    ...
    if (userType === 'advertiser') {
      axios({
        method: 'get',
        url: CMS_STRAPI_URL + '/postarticles?advertiser_id=' + userTypeId + '&status=rejected&_sort=created_at:DESC',
        headers: {
          Authorization:
            'Bearer ' + value,
        }
      ...
      axios({
        method: 'get',
        url: CMS_STRAPI_URL + '/postarticles?influencer_id=' + userTypeId + '&status=rejected&_sort=created_at:DESC',
        headers: {
          Authorization:
            'Bearer ' + value,
        }
  ...
  render() {
    ...
    return (
      <Fragment>
        <Breadcrumb title="Rejected Posts" parent="Ecommerce" />
                    ...
                    <table className="table table-bordernone">
                      ...
                      <tbody>
                        ...
                        {data != 'nodata' ? dataList.length > 0 ? dataList.map((item, index) => {
                          return (
                            <tr className={index % 2 == 0 ? "table-active" : "table-light"}>
                              ...
                              <td>{null != item.price ? item.price : 0}</td>
                          ...
                          <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td className="h3 text-center">No rejected post!</td>
                            <td></td>
                            <td></td>
                          </tr>
                        }
                        ...
                        {/* <tr className="title-orders" style={{ display: 'none' }}>
                          ...
                          <td></td>
                          <td></td>
                          <td><i class="fa fa-usd" style={{ fontSize: 17 }}>{null != dataList.amount ? dataList.amount : 0}</i></td>
                          <td></td>
                          <td></td>
                        </tr> */}
                      </tbody>
